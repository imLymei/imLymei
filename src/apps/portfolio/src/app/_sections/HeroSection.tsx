      ...
      <div className="z-10 flex flex-col items-center gap-6">
        ...
        <h1 className="mb-6 w-fit text-5xl font-bold md:text-7xl lg:text-9xl">
          ...
          <span className="relative">
            ...
            <div className="absolute right-6 -bottom-2 flex flex-col gap-1 text-xs max-lg:translate-y-1/2 max-md:translate-x-1/2 lg:text-sm">
              <p className="flex items-center justify-center rounded-full bg-violet-500 px-4 py-1 lg:py-2">
